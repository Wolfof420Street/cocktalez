...
class CocktailByGlassGrid extends StatefulWidget {
  final CocktailResponse cocktailResponse;

   final void Function(Drinks) onPressed;

  const CocktailByGlassGrid({super.key, required this.cocktailResponse, required this.onPressed});

  @override
  State<CocktailByGlassGrid> createState() => _CocktailByGlassGridState();
}

class _CocktailByGlassGridState extends State<CocktailByGlassGrid> {
            ...
            slivers: [
              SliverPadding(
                ...
                sliver: SliverMasonryGrid.count(
                  ...
                  itemBuilder: (context, index) => _GlassTile(
